...
export const VitalsLayoutItem = ({
  ...
  return (
    <div
      key={id}
      className={cn(
        "group/bento row-span-1 flex w-[28vw] cursor-pointer flex-col justify-between space-y-4 overflow-clip rounded-xl border border-2 border-gray-400 border-transparent bg-[--fixed-bg-color] p-[0.1px]",
      )}
    >
